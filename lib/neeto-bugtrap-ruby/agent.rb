...
module NeetoBugtrap
  ...
  class Agent
    ...
    # Sends an exception to NeetoBugtrap. Does not report ignored exceptions by
    # default.
    #
    # @example
    #   # With an exception:
    ...
    # notice is reported to NeetoBugtrap, all breadcrumbs within the execution
    # path will be appended to the notice. You will be able to view the
    # breadcrumb trace in the NeetoBugtrap interface to see what events led up
    # to the notice.
    #
    # @example
