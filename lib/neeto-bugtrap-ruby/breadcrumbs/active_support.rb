      ...
      def self.default_notifications
        {
          ...
          'sql.active_record' => {
            ...
            category: 'query',
            select_keys: %i[sql name connection connection_id cached],
          ...
          'perform_action.action_cable' => {
            ...
            select_keys: %i[channel_class action],
            category: 'render'
          },
          ...
          'process_action.action_controller' => {
            ...
            select_keys: %i[controller action format method path status view_runtime db_runtime],
            category: 'request'
          },
          'start_processing.action_controller' => {
            message: 'Action Controller Start Process',
            select_keys: %i[controller action format method path],
            category: 'request'
          },
          ...
          'deliver.action_mailer' => {
            ...
            select_keys: %i[mailer message_id from date],
            category: 'render'
          }
        }
      end
